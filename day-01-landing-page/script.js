...
const translations = {
  en: {
    ...
    heroEyebrow: "Day 01 / AI-assisted build log",
    ...
    heroPrimary: "Explore Day 01",
    heroRepo: "View GitHub repo",
    panelLabel: "Lab signal",
    signalPrompt: "Prompt trail",
    signalPromptValue: "Recorded",
    signalBuild: "Build mode",
    signalShip: "Ship state",
    signalToday: "Live today",
  ...
  es: {
    ...
    heroEyebrow: "Día 01 / Bitácora con IA",
    ...
    heroPrimary: "Explorar Día 01",
    heroRepo: "Ver repo en GitHub",
    panelLabel: "Señal del lab",
    signalPrompt: "Rastro de prompts",
    signalPromptValue: "Registrado",
    signalBuild: "Modo de build",
    signalShip: "Estado",
    signalToday: "Publicado hoy",
  ...
  it: {
    ...
    heroPrimary: "Esplora Giorno 01",
    heroRepo: "Vedi repo GitHub",
    panelLabel: "Segnale lab",
    signalPrompt: "Traccia prompt",
    signalPromptValue: "Salvata",
    signalBuild: "Modalità build",
    signalShip: "Stato",
    signalToday: "Online oggi",
  ...
  fr: {
    ...
    heroPrimary: "Explorer Jour 01",
    heroRepo: "Voir le repo GitHub",
    panelLabel: "Signal du lab",
    signalPrompt: "Trace des prompts",
    signalPromptValue: "Archivée",
    signalBuild: "Mode build",
    signalShip: "État",
    signalToday: "En ligne",
  ...
  pt: {
    ...
    heroPrimary: "Explorar Dia 01",
    heroRepo: "Ver repo no GitHub",
    panelLabel: "Sinal do lab",
    signalPrompt: "Trilha de prompts",
    signalPromptValue: "Registrada",
    signalBuild: "Modo build",
    signalShip: "Estado",
    signalToday: "No ar hoje",
